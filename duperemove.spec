...
Version  : 0.11.3
Release  : 7
URL      : https://github.com/markfasheh/duperemove/archive/v0.11.3/duperemove-0.11.3.tar.gz
Source0  : https://github.com/markfasheh/duperemove/archive/v0.11.3/duperemove-0.11.3.tar.gz
...
%prep
%setup -q -n duperemove-0.11.3
cd %{_builddir}/duperemove-0.11.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628612610
...
cp %{_builddir}/duperemove-0.11.3/LICENSE %{buildroot}/usr/share/package-licenses/duperemove/cca1a98df1d42b70d0e705fe296bf45230196c14
cp %{_builddir}/duperemove-0.11.3/LICENSE.xxhash %{buildroot}/usr/share/package-licenses/duperemove/faa50d629c27ea217aba549a466c7082430e1528
